...
public class Aresta implements org.apache.thrift.TBase<Aresta, Aresta._Fields>, java.io.Serializable, Cloneable, Comparable<Aresta> {
  ...
  public int hashCode() {
    ...
    boolean present_peso = true;
    list.add(present_peso);
    if (present_peso)
      list.add(peso);

    boolean present_direcionada = true;
    list.add(present_direcionada);
    if (present_direcionada)
      list.add(direcionada);

    boolean present_descricao = true && (isSetDescricao());
    list.add(present_descricao);
    if (present_descricao)
      list.add(descricao);
